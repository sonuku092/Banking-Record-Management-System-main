...
// Here data present in class object acc is written to file Banking.dat by calling write function.
...
void write_account()
{
    ...
    infile.open("Banking.dat", ios::binary | ios::in);
...
void modify_account(int n)
{
    ...
    vj.open("Banking.dat", ios::binary | ios::in | ios::out);
...
void delete_account(int n)
{
    ...
    infile.close();
    outfile.close();
    remove("Banking.dat");             // Delete a File from Current Directory
    rename("Temp.dat", "Banking.dat"); // Changes the name of the file or directory specified by oldname to newname.
...
void display_all()
{
    ...
    cout << "\n\n\t\tACCOUNT HOLDER LIST\n\n";
    cout << "===========================================================================================================\n";
    cout << "=   A/C NO.           First NAME           Last Name                 Address      TYPE            BALANCE =\n";
    cout << "===========================================================================================================\n";
